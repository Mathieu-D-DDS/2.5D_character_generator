...
def generate_side_masks(mask_front_path, output_left_path, output_right_path, image_path=None):
    # Optionnellement, on utilise l'image originale pour la détection de pose
    if image_path is None:
        # On essaye de retrouver l'image depuis le masque
    ...
    if results.pose_landmarks:
        ...
        # Bras (rectangle horizontal mince)
        ...
        # Jambe (rectangle vertical mince)
        ...
        # Si pose non détectée, fallback à la version rétrécie simple
    ...
    # Le même masque pour left et right
